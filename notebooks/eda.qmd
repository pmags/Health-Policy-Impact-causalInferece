...
From initial summary we conclude:
- 264 entry points corresponding to the period between 2013-01-01 to 2024-09-01,
- During this period both institutions changed their named therefore we need to merge labels.
- There is no missing data for any time period
- The values publicly available do not represent monthly emergencies but rather acumulated values and we will need calculate the monthly values
